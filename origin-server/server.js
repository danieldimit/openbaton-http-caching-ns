...
app.get("/src/majorca2.mp4", function (req, res) {
    var d = new Date();
    console.log("Video fetched at:", new Date().toLocaleString());
    ...
    res.setHeader("Cache-Control", "public, max-age=60");
    console.log(req.url);
    res.sendFile(path.join(DIST_DIR, "majorca2.mp4"));
});

app.get("/src/majorca.mp4", function (req, res) {
    var d = new Date();
    console.log("Video fetched at:", new Date().toLocaleString());
    ...
    res.setHeader("Cache-Control", "public, max-age=60");
    console.log(req.url);
    res.sendFile(path.join(DIST_DIR, "majorca.mp4"));
});
